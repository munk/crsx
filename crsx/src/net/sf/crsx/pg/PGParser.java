    ...
    use = Use(c_in, c_in, html, false);
                ...
                else if (!use.touched)
                {
                        try
                        {
                                ...
                                factory.parser(factory).parse(generatorSink, unq(use.category), new StringReader(text), null, 1, 1, new LinkedExtensibleMap<String, Variable>().extend(variables));
                        }
                        catch (IOException e)
                        {
                                {if (true) throw new ParseException("CRS term read error: "+e.getMessage()+"\u005cnin "+t.toString());}
    ...
    while (true) {
      ...
      case 3:
        ...
        case CONST:
          ...
          break;
        case EMBEDDED:
          // :«Expr» means "convert using Expr code of type String where # is substituted by the value!
                                  t = jj_consume_token(EMBEDDED);
        ...
        case 29:
          ...
          switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
          case EMBEDDED:
            // :{«Expr»} means reparse using category "computed by Expr code of type String where # is substituted by the value!
                                            t = jj_consume_token(EMBEDDED);
            jj_consume_token(30);
                                                  use.category = unembed(t.toString()).replaceAll("#", use.converted); annotation.append(""+t);
            break;
          case VAR:
          case CONST:
...
/** Complex tokens. */
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x0,0x6,0x10,0x360,0x0,0x0,0x80,0x10,0x0,0x80,0x10,0x360,0x79e0000,0x79e0000,0x79e0000,0x0,0x0,0x0,0x0,0x0,0x408,0x408,0x1000,0x1000,0x800,0x8000,0x20000,0x40000,0x1000,0x1000,0x8,0x800,0x0,0x1000,0x1000,0x8,0x800,0x0,0x10,0x0,0x0,0x0,0x10,0x10,0x10,0x7800000,0xa0000800,0x0,0xa0000800,0x18001000,0x18001000,0xa0000800,0x0,0x0,0x80000000,0x18001000,0x18001000,0x0,0x0,0x0,0x18001000,0x18001000,0x0,0x200000,0x8000,0xa0000800,0x0,0x10,0x0,0x0,0x0,0x0,0x0,0x400,0x400,0x400,0x0,0x8,0x0,0x20000000,0x20000400,0x30000480,0x8,0x8000,0x200800,0x200000,0x7801bc98,0x200800,0x18001000,0x7801bc88,0x7801bc88,0x0,0x7801bc98,0x7801bc98,0x0,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x1000000,0x0,0x0,0x0,0x1a000000,0x3a000000,0x0,0x0,0x3a000000,0x0,0x0,0x0,0x5d100081,0x5c100081,0x5d100081,0x18000000,0x58000080,0x18000000,0x58000080,0x40100080,0x0,0x0,0x18000000,0x18000000,0x0,0x0,0x0,0x0,0x18000000,0x18000000,0x0,0x0,0x4000000,0x18000000,0x18000000,0x0,0x0,0x4000000,0x0,0x1a000000,0x1a000000,0x1a000000,0x0,0x0,0x0,0x0,0x1f100000,0x1000000,0x1f100000,0x0,0x0,0x1e100000,0x18000000,0x1a000000,0x18000000,0x0,0x0,0x5e000080,0x18000000,0x5e000080,0x0,0x0,0x18000000,0x0,0x0,0x1f100000,0x2000002,0x0,0x4,0x20000000,0x40000080,0x8,0x8,0x0,0x18,0x18,0x4,0x20,0x1c000000,0x5c000080,0x0,0x48000088,0x20,0x0,0x1a800000,0x800000,0x3a400ffc,0x1a800000,0x0,0xffc,0x2000ffc,0x38000000,0x3a400ffc,0x3a400ffc,0x18000000,0x40000080,};
   }
